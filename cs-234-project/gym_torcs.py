...
class TorcsEnv:
    ...
    def __init__(self, vision=False, throttle=False, gear_change=False):
        ...
        self.client = game.Client(p=3101, vision=self.vision)  # Open new UDP in vtorcs
    ...
    def reset(self, relaunch=False):
        ...
        client = self.client
        client.get_servers_input(ex=False)  # Get the initial input from torcs
