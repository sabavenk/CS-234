...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        #linear decay rate is the slope of the line connecting (0, eps_being) and (nsteps, eps_end)
        rate = (self.eps_end - self.eps_begin)/float(self.nsteps) 
        new_eps = self.eps_begin + rate*t
        
        self.epsilon = max(float(self.eps_end), new_eps)
        ##############################################################
